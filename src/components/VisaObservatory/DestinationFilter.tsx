...
interface Props {
  /** Todos los iso3 disponibles como destino */
  allDestinations: string[];
  /** Seleccionados actualmente (vacío = todos) */
  selected: string[];
...
export default function DestinationFilter({allDestinations, selected, onChange}: Props): React.JSX.Element {
  ...
  const filtered = allDestinations.filter((iso3) => {
      ...
      <div
        ...
        {!hasSelection && (
          <span className={styles.placeholder}>
            <Search size={14} strokeWidth={2} style={{opacity: 0.45, flexShrink: 0}} />
            Filtrar países destino...
          </span>
        )}
